...
public class Test1 {
	@Given("I am a good developer")
	public void I_am_a_good_developer()
	{
		System.out.println("**********************");
	...
	@Then("I completes it up")
	public void I_completes_it_up()
	{
		System.out.println("I completes it up");
	}
	@And("My boss salutes me")
	public void My_boss_salutes_me()
	{
		System.out.println("My boss salutes me");
	}
	@But("The tester hates me")
	public void The_tester_hates_me()
	{
		System.out.println("The tester hates me");
	}
	
	@Given("I am a bad developer")
	public void I_am_a_bad_developer()
	{
		System.out.println("I am a bad developer");
	}
	@When("I go to work")
	public void I_go_to_work1()
	{
		System.out.println("I go to work");
	}
	@Then("I mess it up")
	public void I_mess_it_up()
	{
	...
	@But("The tester likes me")
	public void The_tester_likes_me()
	{
